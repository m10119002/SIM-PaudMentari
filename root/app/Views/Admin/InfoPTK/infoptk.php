...
<body style="background-color: #dd8f00;">
    <div class="body" style="background-color: #dd8f00;">
        ...
        <div class="container" style="background-color: white; border: 5px solid #823b08fd;">
            <h3 style="font-family: Brush Script MT, Cambria, Cochin, Georgia; font-size: 40px;">Info PTK</h3>
            <table class="table" style="font-size: 13px;">
				...
				<?php foreach ($loadTable as $row): ?>
					<tr>
						...
						<td align=right><a href="<?php echo base_url('admin/infoptk/edit?id='.$row['id']); ?>">Ubah</a> | <a href="<?php echo base_url('admin/infoptk/hapus?id='.$row['id']); ?>">Hapus</a>
				<?php endforeach; ?>
				<?php endif; ?>
				<tr>
					<td colspan=4 align=center><a href="<?php echo base_url('admin/infoptk/tambah'); ?>">Tambah Tenaga Kerja</a>
            </table>
            <br><br>
        </div>
