...
<head>
    ...
    <title>Data Akun - Ubah Password</title>
...
<body style="background-color: #dd8f00;">
    <div class="body" style="background-color: #dd8f00;">
        ...
        <div class="container" style="background-color: white; border: 5px solid #823b08fd;">
            <h3 style="font-family: Brush Script MT, Cambria, Cochin, Georgia; font-size: 40px;">Data Akun - Ubah Password</h3>
			<br>
			<a style="float:right;" href="<?php echo base_url('admin/pendaftaran/akun'); ?>">Kembali</a>
			<?php echo form_open('admin/pendaftaran/akun/ubahpass'); ?>
            <table class="table" style="font-size: 13px;">
				<tr>
                    <td>Username
                    <td style="text-align: center; width: 10%;"> :
                    <td><?php echo isset($loadForm['user'])? $loadForm['user'] : ''; ?>
                <tr>
                    <td>Password
                    <td style="text-align: center; width: 10%;"> :
			...
			<?php echo form_hidden('user', $loadForm['user']); ?>
			<?php echo form_close(); ?>
            <br><br>
        </div>
