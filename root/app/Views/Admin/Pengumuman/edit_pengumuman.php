...
<body style="background-color: #dd8f00;">
    <div class="body" style="background-color: #dd8f00;">
        ...
        <div class="container" style="background-color: white; border: 5px solid #823b08fd;">
            <h3 style="font-family: Brush Script MT, Cambria, Cochin, Georgia; font-size: 40px;">Pengumuman - Ubah</h3>
			<br>
			<a style="float:right;" href="<?php echo base_url('admin/pengumuman'); ?>">Kembali</a>
			<?php echo form_open('admin/pengumuman/edit'); ?>
            <table class="table" style="font-size: 13px;">
                <tr>
                    <td>Isi Pengumuman :
				<tr>
                    <td><textarea class="form-control" rows=30 name="isi" placeholder="Isi Pengumuman .."><?php echo isset($loadForm['isi'])? $loadForm['isi'] : ''; ?></textarea>
				<?php if(isset($validation['isi'])): ?>
				<tr>
					<td align=center><span><?php echo $validation['isi']; ?></span>
				<?php endif; ?>
                <tr>
                    <td align=center><input class="btn btn-primary" type=submit value="Simpan" />
            </table>
