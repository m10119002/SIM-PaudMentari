    ...
    <div class="body" style="background-color: #dd8f00;">
        ...
        <div class="container" style="background-color: white; border: 5px solid #823b08fd;">
            ...
            <table class="table" style="font-size: 13px;">
                ...
                <tr>
                    <td><?php echo nl2br($row['isi']); ?>
					<td style="vertical-align: middle;"><a href="<?php echo base_url('admin/pengumuman/edit?id='.$row['id']); ?>">Ubah</a>
					<td style="vertical-align: middle;"><a href="<?php echo base_url('admin/pengumuman/hapus?id=').$row['id']; ?>">Hapus</a>
				<?php endforeach; ?>
				<?php endif; ?>
				<tr>
					<td colspan=3><a href="<?php echo base_url('admin/pengumuman/tambah'); ?>">Tambah Pengumuman</a>
            </table>
            <br><br>
        </div>
