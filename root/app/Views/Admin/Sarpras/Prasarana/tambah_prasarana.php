...
<body style="background-color: #dd8f00;">
    <div class="body" style="background-color: #dd8f00;">
        ...
        <div class="container" style="background-color: white; border: 5px solid #823b08fd;">
            <h3 style="font-family: Brush Script MT, Cambria, Cochin, Georgia; font-size: 40px;">Info Sarpras - Tambah Prasarana</h3>
			<br>
			<a style="float:right;" href="<?php echo base_url('admin/sarpras'); ?>">Kembali</a>
			<?php echo form_open('admin/sarpras/prasarana/tambah'); ?>
            <table class="table" style="font-size: 13px;">
                <tr>
                    <td>Nama Sarana
                    <td style="text-align: center; width: 10%;"> :
                    <td><input class="form-control" type=text size=64 name="nama" placeholder="Nama Prasarana (contoh: Meja Siswa)" value="<?php echo isset($loadForm['nama'])? $loadForm['nama'] : ''; ?>"/>
                ...
                <tr>
                    <td>Jumlah
                    <td style="text-align: center; width: 10%;"> :
                    <td><input class="form-control" type=number size=64 name="jumlah" placeholder="Jumlah Prasarana" value="<?php echo isset($loadForm['jumlah'])? $loadForm['jumlah'] : ''; ?>"/>
