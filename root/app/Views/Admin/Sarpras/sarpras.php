    ...
    <div class="body" style="background-color: #dd8f00;">
        ...
        <div class="container" style="background-color: white; border: 5px solid #823b08fd;">
            ...
            <table class="table" style="font-size: 13px;">
                ...
                <tr>
                    <td colspan="4" style="text-align: center; font-size: 17px;"><b>Sarana</b>
                ...
                <tr>
					...
					<td align=right><a href="<?php echo base_url('admin/sarpras/sarana/edit?id='.$row['id']); ?>">Ubah</a> | <a href="<?php echo base_url('admin/sarpras/sarana/hapus?id='.$row['id']); ?>">Hapus</a>
				<?php endforeach; ?>
				<?php endif; ?>
				<tr>
					<td colspan=4 align=center><a href="<?php echo base_url('admin/sarpras/sarana/tambah'); ?>">Tambah Sarana</a>
                <tr>
                    <td colspan="4" style="text-align: center; font-size: 17px;"><b>Prasarana</b>
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: 10%;"> :
                    <td><?php echo $row['jumlah']; ?>
					<td align=right><a href="<?php echo base_url('admin/sarpras/prasarana/edit?id='.$row['id']); ?>">Ubah</a> | <a href="<?php echo base_url('admin/sarpras/prasarana/hapus?id='.$row['id']); ?>">Hapus</a>
                <?php endforeach; ?>
				<?php endif; ?>
				<tr>
					<td colspan=4 align=center><a href="<?php echo base_url('admin/sarpras/prasarana/tambah'); ?>">Tambah Prasarana</a>
            </table>
