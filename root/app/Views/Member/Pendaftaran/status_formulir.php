...
<body style="background-color: #dd8f00;">
    <div class="body" style="background-color: #dd8f00;">
        ...
        <div class="container" style="background-color: white; border: 5px solid #823b08fd;">
            <h3 style="font-family: Brush Script MT, Cambria, Cochin, Georgia; font-size: 40px;">Status Formulir</h3>
            <table class="table" style="font-size: 13px;">
				<tr>
					<td>Status Formulir
					<td style="text-align: center; width: 10%;"> :
					<td><?php echo isset($status)? $status: "N/A"; ?>
				<tr>
				<tr>
					<td>Pesan Status
					<td style="text-align: center; width: 10%;"> :
					<td><?php echo isset($pesan)? $pesan: "-"; ?>
				<tr>
					<td>
					<td style="text-align: center; width: 10%;">
					<?php if(!isset($status)): ?>
						<td><a class="btn btn-primary" href="<?php echo base_url('member/pendaftaran/daftar'); ?>">Ajukan Pendaftaran</a>
					<?php else: ?>
						<td><a class="btn btn-primary" href="<?php echo base_url('member/pendaftaran/formulir'); ?>">Periksa Formulir</a>
					<?php endif; ?>
            </table>
            <br><br>
        </div>
